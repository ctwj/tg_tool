...
CREATE TABLE IF NOT EXISTS collector_histories (
    ...
    post_time DATETIME,
    raw_data TEXT,
    is_auto_push BOOLEAN DEFAULT 0,
...
-- Insert default root user (password: 123456)
-- The password hash is inserted at runtime by the application
-- to avoid bcrypt version incompatibility issues.
-- See main.rs: ensure_root_user()
