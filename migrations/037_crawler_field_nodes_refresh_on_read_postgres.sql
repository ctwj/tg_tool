-- 037: crawler_task_field_nodes 加 refresh_on_read 列 (PostgreSQL) — feature 046-crawler-script-extractor
...
ALTER TABLE crawler_task_field_nodes
    ADD COLUMN refresh_on_read BOOLEAN NOT NULL DEFAULT FALSE;
