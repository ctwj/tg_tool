-- 031: crawler_field_library resource 类补 download_url / resource_name + sort_order 重排 (PostgreSQL)
-- 修复已运行过 027（旧 24 条）的现有 DB：把 file_size(22)/duration(23)/version(24) 后移到 24/25/26，
-- 再补插 download_url(22) / resource_name(23)。
